        ...
        {showCategories && (
          <ul className="bg-gray-50 py-2 px-4 border-t border-gray-200">
            <li className="py-1 hover:bg-gray-100">
              <Link href="/mens-clothing" className="text-gray-700 text-xl hover:text-blue-500">Men&apos;s Collection</Link>
            </li>
            <li className="py-1 hover:bg-gray-100">
              <Link href="/womens-clothing" className="text-gray-700 text-xl hover:text-blue-500">Women&apos;s Collection</Link>
            </li>
            <li className="py-1 hover:bg-gray-100">
              <Link href="/jewelery" className="text-gray-700 text-xl hover:text-blue-500">Jewelry</Link>
            </li>
            <li className="py-1 hover:bg-gray-100">
              <Link href="/electronics" className="text-gray-700 text-xl hover:text-blue-500">Electronics</Link>
            </li>
          </ul>
        )}
      </div>
